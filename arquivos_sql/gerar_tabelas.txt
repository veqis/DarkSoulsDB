...
CREATE TABLE armaduras (
	...
	tipo_armadura VARCHAR(45) NOT NULL check ( tipo_armadura = 'Head Armor' or tipo_armadura = 'Chest Armor' or tipo_armadura = 'Hands Armor' or tipo_armadura = 'Legs Armor'),
  	r_fis DECIMAL NOT NULL,
  	r_impacto DECIMAL NOT NULL,
  	r_corte DECIMAL NOT NULL,
  	r_perfurar DECIMAL NOT NULL,
 	r_magic DECIMAL NOT NULL,
  	r_fogo DECIMAL NOT NULL,
  	r_electro DECIMAL NOT NULL,
...
CREATE TABLE equipa (
  nome_item VARCHAR(45) NOT NULL,
  nome_personagem VARCHAR(45) NOT NULL,
  slot VARCHAR(45) NOT NULL check ( slot = 'm_esquerda_1' or slot = 'm_esquerda_2' or slot = 'm_direita_1' OR slot = 'm_direita_1' or slot = 'capacete' or slot = 'peitoral' or slot = 'luvas' or slot = 'botas' or slot = 'anel_1' or slot = 'anel_2' or slot = 'ammo_1' or slot = 'ammo_2' or slot = 'ammo_3' or slot = 'ammo_4' or slot = 'cinto_1' or slot = 'cinto_2' or slot = 'cinto_3' or slot = 'cinto_4' or slot = 'cinto_5' ),
...
CREATE TABLE respawn (
  ...
  nome_mapa VARCHAR(45) NOT NULL UNIQUE,
  nivel_bonefire INT NULL,
  FOREIGN KEY (nome_personagem) REFERENCES personagens (nome) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (nome_mapa) REFERENCES mapas (nome) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE progresso (
  nome_personagem VARCHAR(45) NOT NULL,
  nome_boss VARCHAR(45) NOT NULL,
  UNIQUE (nome_personagem, nome_boss),
  FOREIGN KEY (nome_personagem) REFERENCES personagens (nome) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (nome_boss) REFERENCES entidades (nome) ON DELETE CASCADE ON UPDATE CASCADE
);
